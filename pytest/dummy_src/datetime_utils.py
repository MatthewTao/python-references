...
def combine_date_and_time(str_date: str, date_format: str, str_time: str, time_format: str) -> tuple:
    """
...
def string_datetime_to_epoch(str_datetime: str, str_format: str = None) -> int:
    ...
    if isinstance(str_datetime, str):
        ...
        raise TypeError(f'string_datetime_to_epoch only works with strings, '
